 ...
 *
 * BÀI TOÁN:
 * Cho một mảng đã sắp xếp và một `target`. Tìm dải chỉ số bắt đầu và kết thúc của `target`.
 * Ví dụ: arr = [5,7,7,8,8,10], target = 8 -> Output: [3, 4]
 */

/**
 * Cách tiếp cận 1: Lai giữa Binary Search & Mở rộng tuyến tính (Hybrid Approach)
...
/**
 * Cách tiếp cận 2 (Tối ưu chuẩn LeetCode): Sử dụng 2 lần Binary Search độc lập
